...
# load random walk method
source $script_dir/main/random_walk_methods.tcl

puts "beam_case $beam_case UPDATED2"

# Load machines from previous step
#############################################################################
load_beamline_status "test" /afs/cern.ch/work/j/jogren/TuningStudies/CLIC_FFS_380GeV/SingleBeamTuning_v07_tuned_beams/main/Results/Results_with_misalignments_updated2/machine_status_step2_$beam_case.dat
source $script_dir/scripts/checkStatus.tcl

set iter [random_walk_sq 30]
...
#############################################################################
save_beamline_status "test" /afs/cern.ch/work/j/jogren/TuningStudies/CLIC_FFS_380GeV/SingleBeamTuning_v07_tuned_beams/main/Results/Results_with_misalignments_updated2/machine_status_step3_$beam_case.dat
save_tuning_data /afs/cern.ch/work/j/jogren/TuningStudies/CLIC_FFS_380GeV/SingleBeamTuning_v07_tuned_beams/main/Results/Results_with_misalignments_updated2/tuning_data_step3_$beam_case.dat

#BeamlineList -file lattice-$machine.tcl
BeamlineList -file /afs/cern.ch/work/j/jogren/TuningStudies/CLIC_FFS_380GeV/SingleBeamTuning_v07_tuned_beams/main/Results/Results_with_misalignments_updated2/lattice_step3-$beam_case.tcl
